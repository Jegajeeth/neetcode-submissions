        ...
        for(int i = 0; i < board.Length; i++)
        {
            for(int j = 0; j < board.Length; j++)
            {
                ...
                if(rowElement != '.')
                {
                    ...
                    // exclude already checked row and column elements along with the intersecting element,
                    // for the sub-square in a sudoko.
                ...
                if(colElement != '.')
                {
                    ...
                    // exclude already checked row and column elements,
                    // include the common shared row and column intersecting element. 
                    // because, the element should atleast be added once in the check heap table.
